...
if(current_room != last_room)
{
	...
	{//Menu
		...
		audio_sound_gain(soundMenu, 1, 1);
	}
	
	else if((current_room == "roomDeserto" || current_room == "roomCity1" || current_room == "roomBoat1" || current_room == "roomBoat2" || current_room == "roomForest1" || current_room == "roomForest2" || current_room = "roomCity2") && !audio_is_playing(soundTrack1))
	{//RESTO
	...
	{//lua
		...
		audio_sound_gain(sound_lua, 1, 1);
	}
	...
	{// bosses
		...
		audio_sound_gain(sound_boss_intro, 1, 1500);
	}
}
...
if((current_room == "roomBoss1" || current_room == "roomBoss2" || current_room == "roomBoss3") && !audio_is_playing(sound_boss))
{
	if(!audio_is_playing(sound_boss_intro) && !audio_is_playing(sound_boss))
	{
		...
		audio_sound_gain(sound_boss, 1, 1);
	}
}
...
if(audio_is_playing(sound_boss) || audio_is_playing(sound_boss_intro) || audio_is_playing(sound_lua) || audio_is_playing(soundMenu) || audio_is_playing(soundTrack1))
{
	...
	if(audio_sound_get_gain(sound_lua) == 0 && !(current_room == "roomMoon1" || current_room == "roomMoon2" || current_room == "roomMoon3")) audio_stop_sound(sound_lua);
	if(audio_sound_get_gain(soundMenu) == 0 && !(current_room == "roomMenu" || current_room == "roomTEIXEIRA")) audio_stop_sound(soundMenu);
	if(audio_sound_get_gain(soundTrack1) == 0 && !(current_room == "roomDeserto" || current_room == "roomCity1" || current_room == "roomBoat1" || current_room == "roomBoat2" || current_room == "roomForest1" || current_room == "roomForest2" || current_room = "roomCity2")) audio_stop_sound(soundTrack1);
} 
