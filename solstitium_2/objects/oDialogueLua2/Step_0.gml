if(place_meeting(x, y, player)){ //checa a colisao
	...
	if(keyboard_check(ord("E"))){ //checa se o botao de ativar o dialogo foi pressionado
		if(!instance_exists(oTextbox)){
			...
			with(dialogue_box){
				text[0] = "Então você conseguiu derrotar aquela planta?";
				text[1] = "Eu... não sei o que dizer além de que você está perto";
				text[2] = "Essa alucinação que fala agora com você um dia será real de novo";
				text[3] = "Continue, guerreiro da lua, e acabe com esse eterno solstício.";
