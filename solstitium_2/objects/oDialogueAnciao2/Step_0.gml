if(place_meeting(x, y, player)){ //checa a colisao
	...
	if(keyboard_check(ord("E"))){ //checa se o botao de ativar o dialogo foi pressionado
		if(!instance_exists(oTextbox)){
			...
			with(dialogue_box){
				text[0] = "Você já está aqui? Mas...";
				text[1] = "Lembra do que eu te falei de atacar no momento certo?";
				text[2] = "Então, esse guardião é um pouco... estranho";
				text[3] = "Mas não subestime a força dele";
				text[4] = "Seja ágil, e use a neve para tentar se esconder";
				text[5] = "Que Hudal e suas runas tragam de volta a noite para essas terras. Vá em frente, bravo viajante";
